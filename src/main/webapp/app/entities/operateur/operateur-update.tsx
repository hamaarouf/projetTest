  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="project1App.operateur.home.createOrEditLabel" data-cy="OperateurCreateUpdateHeading">
            <Translate contentKey="project1App.operateur.home.createOrEditLabel">Create or edit a Operateur</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('project1App.operateur.centreRc')}
              ...
              />
              <ValidatedField
                label={translate('project1App.operateur.numeroRc')}
