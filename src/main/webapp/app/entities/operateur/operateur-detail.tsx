    ...
    <Row>
      <Col md="8">
        <h2 data-cy="operateurDetailsHeading">
          <Translate contentKey="project1App.operateur.detail.title">Operateur</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="centreRc">
              <Translate contentKey="project1App.operateur.centreRc">Centre Rc</Translate>
            </span>
          </dt>
          <dd>{operateurEntity.centreRc}</dd>
          <dt>
            <span id="numeroRc">
              <Translate contentKey="project1App.operateur.numeroRc">Numero Rc</Translate>
            </span>
          </dt>
