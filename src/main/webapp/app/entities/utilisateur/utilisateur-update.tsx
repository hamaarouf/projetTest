  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="project1App.utilisateur.home.createOrEditLabel" data-cy="UtilisateurCreateUpdateHeading">
            <Translate contentKey="project1App.utilisateur.home.createOrEditLabel">Create or edit a Utilisateur</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('project1App.utilisateur.nomUtilisateur')}
              ...
              />
              <ValidatedField
                label={translate('project1App.utilisateur.prenom')}
                id="utilisateur-prenom"
                name="prenom"
                data-cy="prenom"
                type="text"
              />
              <ValidatedField label={translate('project1App.utilisateur.nom')} id="utilisateur-nom" name="nom" data-cy="nom" type="text" />
              <ValidatedField
                label={translate('project1App.utilisateur.dateInscription')}
              ...
              />
              <ValidatedField
                label={translate('project1App.utilisateur.password')}
              ...
              <ValidatedField
                ...
                name="operateur"
                data-cy="operateur"
                label={translate('project1App.utilisateur.operateur')}
                type="select"
              >
                <option value="" key="0" />
                {operateurs
