    ...
    <Row>
      <Col md="8">
        <h2 data-cy="utilisateurDetailsHeading">
          <Translate contentKey="project1App.utilisateur.detail.title">Utilisateur</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="prenom">
              <Translate contentKey="project1App.utilisateur.prenom">Prenom</Translate>
            </span>
          </dt>
          <dd>{utilisateurEntity.prenom}</dd>
          <dt>
            <span id="nom">
              <Translate contentKey="project1App.utilisateur.nom">Nom</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="password">
              <Translate contentKey="project1App.utilisateur.password">Password</Translate>
            </span>
          </dt>
          <dd>{utilisateurEntity.password}</dd>
          <dt>
            <Translate contentKey="project1App.utilisateur.operateur">Operateur</Translate>
          </dt>
